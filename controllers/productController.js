...
exports.addProduct = async (req, res, next) => {
  ...
  try {
    ...
    const product = await Product.create(
      {
        ...
        video: videoBuffer, // Store video in base64 format
        videoContentType,
    ...
    // Prepare image data for bulk insertion
    ...
    // Insert specifications (sections and their data)
...
exports.updateProduct = async (req, res, next) => {
  ...
  try {
    ...
    // Prepare video data if provided
    const videoBuffer = video && video[0] ? video[0].buffer : null;
    const videoContentType = video && video[0] ? video[0].mimetype : null;
